...
int hisd_getdata_by_pixlin(HisdHeader *header,FILE *fp,float pix,float lin,
    unsigned short *sout);
int hisd_getdataindex_by_pixlin(HisdHeader* header, float nPix, float nLin,
	int* sout);
...
int pixlin_to_lonlat(const HisdHeader *head,float pix,float lin,
	double *lon,double *lat);
int lonlat_to_pixlin(const HisdHeader *head,double lon,double lat,
	float *pix,float *lin);
